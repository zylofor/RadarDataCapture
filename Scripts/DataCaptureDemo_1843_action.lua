ar1.FullReset()
ar1.SOPControl(2)
ar1.Connect(15,115200,1000)

--BSS and MSS firmware download
info = debug.getinfo(1,'S');
file_path = (info.source);
file_path = string.gsub(file_path, "@","");
file_path = string.gsub(file_path, "DataCaptureDemo_1843_action.lua","");
...
adc_data_path = "G:\\MyDataset\\DatasetFile\\Action\\adc_data.bin"
...
-------------------------------------ProfileConfig-------------------------------------
--0, 77, 60, 6, 40, 0, 0, 0, 0, 0, 0, 99.987, 1, 64, 2000, 0, 0, 40--gesture
--0, 77, 60, 6, 65, 0, 0, 0, 0, 0, 0, 60.012, 1, 256, 4400, 0, 0, 40--test1
if((partId == 1642) or (partId == 1843)) then
    if(ar1.ProfileConfig(0, 77, 60, 6, 65, 0, 0, 0, 0, 0, 0, 60.012, 1, 256, 4400, 0, 0, 40) == 0) then
...
-------------------------------------FrameConfig-------------------------------------
--0, 1,  100, 200, 60,   0, 0, 1--gesture
--0, 2,  600, 64, 100,   0, 0, 1--test1
if (ar1.FrameConfig(0, 2,  600, 64, 100,   0, 0, 1) == 0) then
